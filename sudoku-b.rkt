...
;; sudoku).
;;
;; A função <solve> analisa, em ordem, todas possibilidades para
;; completar o sudoku (usando como critéiro de possibilidade o
;; predicado <possible?>), mas imprime apenas aquelas nas quais as
;; modificações ocorreram de modo a ser possível completá-lo,
;; terminando as chamadas recursivas que chegam em becos sem saída.
